...
//     }
    ...
    load_mnist_dataset("D:/Code/Cpp/dlibdetector2015/data", training_images, training_labels, testing_images, testing_labels);

	std::vector<float> training_labels_float;
	std::vector<float> testing_labels_float;
	for (int i = 0; i < training_labels.size(); i++)
		training_labels_float.push_back((float)training_labels[i]);

	for (int i = 0; i < testing_labels.size(); i++)
		testing_labels_float.push_back((float)testing_labels[i]);
...
//                                 >>>>>>>>>>>>>>;
    ...
    trainer.train(training_images, training_labels_float);
    ...
    std::vector<float> predicted_labels = net(training_images);
//     int num_right = 0;
//     int num_wrong = 0;
...
//         else
//             ++num_wrong;
// 		std::cout << "True = " << training_labels_float[i] << ", Sim = " << predicted_labels[i] << std::endl;
//     }
...
//         else
//             ++num_wrong;
		std::cout << "True = " << testing_labels_float[i] << ", Sim = " << predicted_labels[i] << std::endl;
    }
