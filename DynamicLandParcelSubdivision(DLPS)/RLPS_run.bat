...
DLPS.exe -inputFile data/shenzhentaz.shp -outputFile data/shenzhentaz_split0.shp -split_flag_field split_flag -maxIteration 3 -maxSize 0 -N 3.0 -print 0 -limit 0
DLPS.exe -inputFile data/shenzhentaz.shp -outputFile data/shenzhentaz_split1.shp -split_flag_field split_flag -maxIteration 3 -maxSize 3000000 -print 0 -limit 0
echo exit
pause > nul 